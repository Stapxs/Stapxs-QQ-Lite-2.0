    ...
    <div>
      <div class="ss-card logo-card">
        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
          ...
          <g id="圖層_1">
            <path class="st1" d="M546.6,774.4c-46.5,0-89.1-15.5-116.6-38.8c-13.9,4.2-31.8,10.9-43,19.2c-9.6,7.1-8.4,14.4-6.7,17.3c7.6,12.9,130.7,8.2,166.3,4.2V774.4z M546.6,774.4c46.5,0,89.1-15.5,116.6-38.8c13.9,4.2,31.8,10.9,43,19.2c9.6,7.1,8.4,14.4,6.7,17.3c-7.6,12.9-130.7,8.2-166.3,4.2V774.4z"></path>
            <path class="st1" d="M546.9,496c76.7-0.5,138.2-15.4,159-21.1c5-1.4,7.6-3.8,7.6-3.8c0-0.7,0.3-12.5,0.3-18.6c0-102.4-48.3-205.3-167.3-205.3c-118.9,0-167.3,102.9-167.3,205.3c0,6.1,0.3,17.9,0.3,18.6c0,0,2.2,2.3,6.1,3.4c19.2,5.4,81.9,20.9,160.5,21.5H546.9z M755.4,581.3c-4.8-15.3-11.2-33.2-17.8-50.3c0,0-3.8-0.5-5.7,0.1c-59,17.1-130.5,28.1-185,27.4h-0.6c-54.2,0.6-125.2-10.1-184-27.1c-2.2-0.6-6.7-0.4-6.7-0.4c-6.6,17.1-13.1,35-17.8,50.3c-22.7,73-15.3,103.2-9.7,103.9c12,1.5,46.7-54.9,46.7-54.9c0,57.3,51.7,145.3,170.2,146.1h3.1c118.5-0.8,170.2-88.8,170.2-146.1c0,0,34.7,56.4,46.7,54.9C770.7,684.5,778,654.3,755.4,581.3"></path>
            <path class="st1" d="M504.3,398.5c-16.1,0.7-29.9-17.6-30.8-41c-0.9-23.4,11.5-42.9,27.6-43.6c16.1-0.7,29.9,17.6,30.8,41C532.8,378.3,520.4,397.8,504.3,398.5 M619.7,357.5c-0.9,23.4-14.6,41.7-30.8,41c-16.1-0.7-28.5-20.3-27.6-43.6c0.9-23.4,14.6-41.7,30.8-41C608.2,314.6,620.6,334.1,619.7,357.5 M322.4,247.2"></path>
            <path class="st1"
            ...
            <path class="st1" d="M546.9,555.1h-0.6c-37.1,0.4-82-4.5-125.5-13c-3.7,21.6-6,48.7-4,81c4.9,81.7,53.4,133.1,128.3,133.8h3c74.9-0.7,123.4-52.1,128.3-133.8c1.9-32.3-0.3-59.4-4-81C628.9,550.7,584,555.6,546.9,555.1">
            </path>
            <path class="st1" d="M441.4,548.3v80.4c0,0,36.8,7.4,73.7,2.3v-74.2C491.7,555.5,466.5,552.6,441.4,548.3"></path>
            <path class="st1" d="M713.6,471.1c0,0-71.6,22.6-166.7,23.3h-0.6c-94.9-0.6-166.4-23.2-166.7-23.3l-24,59.9c60,18.1,134.4,29.8,190.6,29.1h0.6c56.2,0.7,130.6-11,190.7-29.1L713.6,471.1z"></path>
          </g>
        </svg>
        <div>
          <span>{{ $t('name') }}</span>
      ...
      <div v-if="contributors.length > 0" class="ss-card contributors-card">
        <div>
          <div v-for="info in contributors"
