...
<template>
  <div class="opt-page">
    <div class="ss-card">
        ...
        <div class="opt-item">
          ...
          <div>
            ...
            <span><a style="cursor:pointer;" @click="sendAbab">{{ $t('option.dev.debug_msg_tip') }}</a></span>
          </div>
          <label class="ss-switch">
    ...
    <div class="ss-card">
        <header>{{ $t('option.dev.test') }}</header>
        <div class="opt-item">
...
export default {
  ...
  methods: {
    ...
    sendAbab: function () {
      popInfo.add(popInfo.appMsgType.info, this.$t('option.dev.debug_msg_tip_1'))
    }
  }
}
</script>
