      ...
      <div :class="'chat-info-base ' + chat.type">
        <div>
          ...
          <div v-if="chat.type === 'group'">
            <svg :title="$t('chat.chat_info.is_owner')" v-if="chat.info.group.gOwner === Vue.loginInfo.account.uin"
            ...
            <svg :title="$t('chat.chat_info.is_admin')"
              v-if="chat.info.group.gAdmins != undefined && chat.info.group.gAdmins.indexOf(Vue.loginInfo.account.uin) >= 0"
              xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
              <path
